...
This is the PatchTST design choice. See INSTRUCTIONS.md for the iTransformer
contingency if cross-channel anomalies show poor AUROC.
...
# ── hyperparameters (match INSTRUCTIONS.md Week 2 spec) ───────────────────────
...
class PatchTST(nn.Module):
    ...
    def __init__(
        ...
        encoder_layer = nn.TransformerEncoderLayer(
            d_model        = d_model,
            nhead          = n_heads,
            dim_feedforward = d_model * 4,  # inner MLP is 4× wider, standard convention
